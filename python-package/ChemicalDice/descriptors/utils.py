...
from ChemicalDice.descriptors.moldataset import MoleculeDatapoint, MoleculeDataset, StandardScaler
from ChemicalDice.descriptors.models import GroverFpGeneration, GroverFinetuneTask
from ChemicalDice.descriptors.nn_utils import initialize_weights
...
def get_data(path: str,
    ...
    if args is not None:
        ...
        features_path = features_path if args.features_path is not None else features_path
    ...
    if features_path is not None:
        #features_data.append(features)  # each is num_data x num_features
        features_data = np.load(path, allow_pickle=True)['features']
