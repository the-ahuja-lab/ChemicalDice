...
from ChemicalDice.descriptors.utils import makedirs
...
def add_fingerprint_args(parser):
    ...
    parser.add_argument('--grover_output', type=str, help='output csv file path')
    parser.add_argument('--id_list', type=str, help='list of ids')
