from ChemicalDice.descriptors.architecture import *                              # Contains the model architecture
from ChemicalDice.descriptors.myImports import *                                 # Contains all import files
