...
def calculate_descriptors(input_filename):
    from ChemicalDice.descriptors.descriptors import smiles_preprocess, bioactivity, chemberta, Grover, ImageMol, chemical, quantum
    # Read the CSV file
...
def train_model(input_dir, input_file, n_components=10, methods = ['AER','plsda','pca','cca'], n_folds = 10):
    from ChemicalDice.descriptors.fusionData import fusionData
    from ChemicalDice.descriptors.plot_data import plot_model_boxplot
...
def predict_model(input_dir,input_file):
    from ChemicalDice.descriptors.predData import fusionData
    from ChemicalDice.descriptors.plot_data import plot_model_boxplot
    """
